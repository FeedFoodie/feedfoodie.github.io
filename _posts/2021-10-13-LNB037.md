...
All of the Wardens attacks rebounded off the gray sphere, sending them flying backward in unison. The sword chi that they were so proud of vanished into thin air, and the recoil damaged their internal organs, causing blood to trickle down from their mouths.
...
<ul>
<li>First-class Expert: Able to emit chi from their weapon.</li>
<li>Peak-level Expert: Able to shape their chi into a weapon.</li>
<li>True Master: Able to utilize Weapon Flux, the refined version of weapon chi. [^1]</li>
</ul>
...
[^1]: Flux: Flux = an evolved form of chi. If regular Chi (氣) is still air, then Flux (罡) is flowing wind.

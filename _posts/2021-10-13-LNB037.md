...
- First-class Expert: Able to emit chi from their weapon.
- Peak-level Expert: Able to shape their chi into a weapon.
- True Master: Able to utilize Weapon Flux, the refined version of weapon chi.[^1]
...
[^1]: Flux: Flux = an evolved form of chi, or enhanced chi. If regular Chi (氣) is still air, then Flux (罡) is flowing wind.

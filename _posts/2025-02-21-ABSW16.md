...
**Translator's Note:** My sincere apologies, I have made a serious mistranslation. The Nine Ironblood Brigades has been changed to the Ironblood Nines, and every previous chapter has been updated to correct the mistake. I was misled by the name, direct translation Nine Roads of Ironblood (hanja 鐵血九路), into thinking that there were "nine groups" when it actually means "groups of nine". 

Anyway, to clarify: The Ironblood Nines has a hundred members, split into eleven squads. Each squad has nine men, which adds up to ninety-nine, plus the Ironblood Commander to reach one hundred. Of those eleven squads, the First Squad that backs up the Ironblood Commander is the strongest. The members are named by squad number+member number, e.g. First One is the number one member of the First Squad.
